...
class WebServer:
    ...
    def _dashboard_html(self):
        ...
        try:
            ...
            ".led-indicators{display:flex;gap:4px;flex-wrap:nowrap;overflow-x:auto}"
            ".led-channel{display:flex;flex-direction:column;align-items:center;gap:4px;min-width:32px}"
            ...
            ".ch-label{font-size:.65em;color:var(--muted);writing-mode:horizontal-tb;white-space:nowrap;"
            "transform:rotate(-45deg);transform-origin:center;max-width:40px;overflow:hidden;text-overflow:ellipsis}"
