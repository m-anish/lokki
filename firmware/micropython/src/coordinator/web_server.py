...
class WebServer:
    ...
    def _dashboard_html(self):
        ...
        return (
            ...
            " const gamma=2.2;"
            " const perceived=Math.pow(pct/100,gamma)*100;"
            " const r=Math.round(100+perceived*1.55);"
            " const g=Math.round(80+perceived*1.4);"
            " const b=Math.round(30+perceived*0.7);"
            " const glow=Math.round(perceived/5);"
